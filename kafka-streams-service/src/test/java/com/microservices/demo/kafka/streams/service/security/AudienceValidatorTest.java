...
class AudienceValidatorTest {
    ...
    private static final String REQUIRED_AUDIENCE = "kafka-streams-service";

    private AudienceValidator validator() {
        KafkaStreamsServiceConfigData configData = new KafkaStreamsServiceConfigData();
    ...
    void validate_jwtContainsRequiredAudience_succeeds() {
        assertThat(validator().validate(jwtWithAudience(List.of(REQUIRED_AUDIENCE))).hasErrors()).isFalse();
    }
